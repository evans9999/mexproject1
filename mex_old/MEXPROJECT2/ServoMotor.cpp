...
ServoMotorPololuBase::ServoMotorPololuBase(unsigned short servoID,                                                     // Erzeugung des Konstruktors 
...
short ServoMotor::
mapPosValue2DegValue(unsigned short p){
	float fact, pos;
	short deg;
