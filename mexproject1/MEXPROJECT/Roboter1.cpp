...
//SERVO0
void Roboter1::  move_servo_0(Pololu conn  ){
...
void Roboter1::  move_servo_1(Pololu conn  ){
// Im Uhrzeigersinn Drehung Servo1
 ...
 cout << "max. pos.:" << Servo0.getMaxPosInAbs()<<endl;
	...
	// gegen Uhrzeigersinn Drehung Servo1
	try{
		
        ServoMotor bServo1(1,4000,0&conn);  
	cout<< "max. pos.:" << Servo1.getMaxPosInAbs()<<end;
	    cout<<"min. pos: " << Servo1.getMinPosInAbs()<<end;
		cout <<"get current pos.:" <<Servo1.getPositionInAbs()<<ebnd;
	}
	catch(IException *e) {
		string msg("Der  Servo 1 des ersten Roboters  hat nicht die entsprechende Position bekommen");
		msf += e->getMsg();
...
// SERVO3
void Roboter1::  move_servo_3(Pololu conn  ){
